...
func (a *fakeActuator) Create(r *cloudkitv1.DNSZone) error {
	return a.FakeActuator.Create(r)
}
func (a *fakeActuator) Delete(r *cloudkitv1.DNSZone) error {
	return a.FakeActuator.Delete(r)
}
func (a *fakeActuator) Update(r *cloudkitv1.DNSZone) error {
	return a.FakeActuator.Update(r)
}
func (a *fakeActuator) Exists(r *cloudkitv1.DNSZone) (bool, error) {
